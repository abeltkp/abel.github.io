				...
				sections = {
					'jp': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/' });
								},
							],
						},
					},
					'en': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/#en' });
								},
							],
						},
					},
					'br': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/#br' });
								},
							],
						},
					},
					'cv-en': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/#cv-en' });
								},
							],
						},
					},
					'cv-br': {
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/#cv-br' });
								},
							],
						},
					},
					'cv-jp': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/#cv-jp' });
								},
							],
						},
					},
					'disclaimer': {
						...
						events: {
							onopen: [
								function() { 
									gtag('config', 'G-M3S6D4N5LG', { 'page_path': '/#disclaimer' });
								},
							],
						},
					},
